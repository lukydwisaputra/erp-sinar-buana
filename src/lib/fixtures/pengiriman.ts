...
import { normalizePhone } from "@/lib/pengiriman-templates";
...
export const pengirimanFixtures: PengirimanLog[] = [
  {
    ...
    tujuanKontak: normalizePhone(picMaju.telepon),
    channel: "whatsapp",
  ...
  },
  {
    ...
    tujuanKontak: normalizePhone(karyawanBudi.telepon),
    channel: "whatsapp",
  ...
  },
  {
    ...
    tujuanKontak: normalizePhone(picKaryaLogam.telepon),
    channel: "whatsapp",
